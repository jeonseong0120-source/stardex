...
export const PACKS: Record<PackId, PackDefinition> = {
  ...
  moe: {
    id: "moe",
    label: "MOE COLLECTION",
    subtitle: "팬메이드 모에몬 테마",
    collectionTitle: "MOE MON",
    collectionSubtitle: "새로운 모험과 캐릭터를 카드로 수집해보세요.",
    openingEyebrow: "STARDEX · MOE COLLECTION",
