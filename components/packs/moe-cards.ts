...
export const MOE_CARDS: MoeCardSeed[] = [
  ...
  { no: "121", name: "쥬피썬더", rarity: "SUPER RARE", flavor: "번개의 해변", scene: "푸른 해변 위에서 전광석화처럼 질주한다.", palette: "sunny", packId: "moe", artwork: "/cards/moe-jolteon-sr.png", englishName: "JOLTEON", description: "햇살보다 빠른 번개가 여름 바다를 가른다." },
  { no: "122", name: "잉어킹", rarity: "RARE", flavor: "작은 도약", scene: "잔잔한 물결 위로 힘차게 몸을 튕긴다.", palette: "sky", packId: "moe", artwork: "/cards/moe-magikarp-r.png", englishName: "MAGIKARP", description: "작은 도약이 언젠가 큰 파도를 만든다." },
  { no: "123", name: "갸라도스", rarity: "MR", flavor: "심해의 분노", scene: "폭풍치는 심해에서 거대한 힘을 깨운다.", palette: "cosmos", packId: "moe", artwork: "/cards/moe-gyarados-mr.png", englishName: "GYARADOS", description: "깊은 바다의 분노가 하늘까지 솟구친다." },
  { no: "124", name: "갸라도스", rarity: "SUPER RARE", flavor: "푸른 포효", scene: "얼어붙은 파도 사이에서 거대한 포효를 울린다.", palette: "sky", packId: "moe", artwork: "/cards/moe-gyarados-mr.png", englishName: "GYARADOS", description: "압도적인 물결이 전장의 모든 시선을 사로잡는다." },
  { no: "125", name: "스라크", rarity: "RARE", flavor: "숲의 쌍검", scene: "초록빛 숲을 가르며 날카로운 칼날을 휘두른다.", palette: "verdant", packId: "moe", artwork: "/cards/moe-scyther-r.png", englishName: "SCYTHER", description: "바람처럼 빠른 두 칼날이 길을 연다." },
  { no: "126", name: "아쿠스타", rarity: "RARE", flavor: "별빛의 조류", scene: "수면 아래 별빛을 품고 조용히 떠오른다.", palette: "sky", packId: "moe", artwork: "/cards/moe-starmie-r.png", englishName: "STARMIE", description: "푸른 보석의 빛이 밤바다를 비춘다." },
  { no: "127", name: "쥬피썬더", rarity: "SUPER RARE", flavor: "황금 전격", scene: "황금빛 전격과 함께 폭풍의 중심을 가른다.", palette: "sunny", packId: "moe", artwork: "/cards/moe-jolteon-sr-2.png", englishName: "JOLTEON", description: "번개의 심장이 가장 눈부신 순간을 만든다." },
  { no: "128", name: "부스터", rarity: "SUPER RARE", flavor: "화염의 휴식", scene: "붉은 요새의 석양 아래 뜨거운 숨을 고른다.", palette: "ember", packId: "moe", artwork: "/cards/moe-flareon-sr.png", englishName: "FLAREON", description: "따뜻한 불꽃이 전장의 긴장을 녹여낸다." },
